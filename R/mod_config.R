      ...
      for (site_id in mapData$rvData$siteIDs) {
        ...
        rest_new_evse_query <-
          glue::glue(
            ...
            "((SELECT last_value FROM analysis_record_analysis_id_seq), {siteDetailRow$trip_count}, ",
            "'",
    ...
    formAnalysisQuery <- function() {
      ...
      query_analysis <-
        glue::glue(#adding sim_date_time
          "INSERT INTO analysis_record (user_id, sim_date_time, status, include_tesla, set_id) VALUES
